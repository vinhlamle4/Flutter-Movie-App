...
class _$_Video extends _Video {
  _$_Video(
      ...
      @JsonKey(name: "official") this.official = false,
  ...
  @override
  String toString() {
    return 'Video(id: $id, name: $name, key: $key, site: $site, size: $size, type: $type, official: $official, publishedAt: $publishedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, key, site, size, type, official, publishedAt);
